export default function PrivacyPolicy() {
  return (
    <body>
      ...
      <p>
        Jonathan U built the Bitetrail app as a Free app. This SERVICE is
        provided by Jonathan U at no cost and is intended for use as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Bitetrail unless otherwise
      ...
      <p>This policy is effective as of 2023-08-15</p>{' '}
      <p>
        <strong>Contact Us</strong>
      </p>{' '}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at juhlmann75@gmail.com.
      </p>{' '}
      <p>
